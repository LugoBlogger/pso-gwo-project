...
def func_transformer(func, n_processes):
  ...
  if (func.__class__ is MethodType) and (func.__code__.co_argcount > 2):
    warnings.warn('mutli-input might be deprecated in the future, use fun(p) instead')
  ...
  valid_mode = ('common', 'multithreading', 'multiprocessing', 'vectorization',
                'cached', 'joblib', 'others')
