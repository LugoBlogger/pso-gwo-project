...
if __name__ == "__main__":
  ...
  num_of_runs = 1000     # 25 - 35 secs / 50 particles
                         # 80 - 120 secs / 400 particles
                         # 174 - 271 secs / 1000 particles
                         # 845 - secs / 5000 particles
  ...
  for i in range(num_of_runs):
    ...
    history_p_arr, history_f_p_arr, history_g_best, history_f_g_best \
      = psoalgo_numba.run_pso_numba(obj_func_1, N_particles, o_sol, D,
                                        M_tensor, bounds, params, rng, 
                                        iter_max=iter_max)
